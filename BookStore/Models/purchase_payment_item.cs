...
namespace BookStore.Models
{
    ...
    public partial class purchase_payment_item
    {
        ...
        public Nullable<int> purchase_payment_item_quantity { get; set; }
        public Nullable<decimal> purchase_payment_item_price { get; set; }
        public Nullable<decimal> purchase_payment_item_money { get; set; }
